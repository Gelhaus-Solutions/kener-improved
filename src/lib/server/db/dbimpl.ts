...
class DbImpl {
  ...
  getLatestPerRegion!: MonitoringRepository["getLatestPerRegion"];
  getReportingRegions!: MonitoringRepository["getReportingRegions"];
  ...
  getProbeRegionRules!: ProbesRepository["getProbeRegionRules"];
  setProbeRegionRule!: ProbesRepository["setProbeRegionRule"];
  getMonitorRegionOverrides!: ProbesRepository["getMonitorRegionOverrides"];
  setMonitorRegionOverride!: ProbesRepository["setMonitorRegionOverride"];
  deleteMonitorRegionOverride!: ProbesRepository["deleteMonitorRegionOverride"];
  ...
  deleteMonitorMergePolicy!: ProbesRepository["deleteMonitorMergePolicy"];
  getMonitorSourcePolicies!: ProbesRepository["getMonitorSourcePolicies"];
  setMonitorSourcePolicy!: ProbesRepository["setMonitorSourcePolicy"];
  deleteMonitorSourcePolicy!: ProbesRepository["deleteMonitorSourcePolicy"];
  deleteMergePoliciesForMonitor!: ProbesRepository["deleteMergePoliciesForMonitor"];
  ...
  private bindMonitoringMethods(): void {
    ...
    this.getLatestPerRegion = this.monitoring.getLatestPerRegion.bind(this.monitoring);
    this.getReportingRegions = this.monitoring.getReportingRegions.bind(this.monitoring);
  ...
  private bindWebhooksMethods(): void {
    ...
    this.getProbeRegionRules = this.probes.getProbeRegionRules.bind(this.probes);
    this.setProbeRegionRule = this.probes.setProbeRegionRule.bind(this.probes);
    this.getMonitorRegionOverrides = this.probes.getMonitorRegionOverrides.bind(this.probes);
    this.setMonitorRegionOverride = this.probes.setMonitorRegionOverride.bind(this.probes);
    this.deleteMonitorRegionOverride = this.probes.deleteMonitorRegionOverride.bind(this.probes);
    ...
    this.deleteMonitorMergePolicy = this.probes.deleteMonitorMergePolicy.bind(this.probes);
    this.getMonitorSourcePolicies = this.probes.getMonitorSourcePolicies.bind(this.probes);
    this.setMonitorSourcePolicy = this.probes.setMonitorSourcePolicy.bind(this.probes);
    this.deleteMonitorSourcePolicy = this.probes.deleteMonitorSourcePolicy.bind(this.probes);
    this.deleteMergePoliciesForMonitor = this.probes.deleteMergePoliciesForMonitor.bind(this.probes);
