...
export default {
  ...
  // B7. Certificate expiry and trust, evaluated on a daily schedule rather than
  // per sample: a TLS handshake per monitor per minute is far too expensive and
  // a certificate does not change between ticks.
